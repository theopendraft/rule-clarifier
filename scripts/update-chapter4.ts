  ...
  try {
    ...
    const chapter = await prisma.chapter.upsert({
      ...
      create: {
        ...
        title: 'Working of Trains Generally',
        htmlContent: htmlContent,
        ruleBookId: 'default-rule-book'
      }
    });

    console.log('Chapter 4 updated successfully:', chapter.id);
    
    // Parse and create individual rules
    const rules = [
      { number: '4.02', title: 'Train Dispatch Timing', content: '<p>No passenger train or mixed train shall be despatched from a station before the advertised time.</p>' },
      { number: '4.03', title: 'Watch Synchronization', content: '<p>Before a train starts from a terminal or crew-changing station, the Guard shall set his watch by the station clock or the clock at the authorised place of reporting for duty and communicate the time to the Loco Pilot who shall set his watch accordingly.</p>' },
      { number: '4.04', title: 'Duty Attendance', content: '<p>Every Guard, Loco Pilot, Assistant Loco Pilot shall be in attendance for duty at such place and at such time as may be prescribed by special instructions.</p>' },
      { number: '4.05', title: 'Running Line Procedures', content: '<p>The Loco Pilot shall take his train along the proper running line.</p>' },
      { number: '4.06', title: 'Double Line Operations', content: '<p>(1) On a double line, every train shall run on the left hand line unless otherwise prescribed by special instructions.</p>' },
      { number: '4.07', title: 'Working Time Table', content: '<p>(1) A copy of the Working Time Table for the time being in force shall be supplied to each station, Guard, Loco Pilot, Inspector of Way or Works, and any other railway servant requiring the use of the Working Time Table during the course of his duties.</p>' },
      { number: '4.08', title: 'Speed Regulations', content: '<p>(1) (a) Every train shall be run on each section of the railway within the limits of speed sanctioned for that section by special instructions.</p>' },
      { number: '4.09', title: 'Caution Orders', content: '<p>(1) Whenever, in consequence of the line being under repair or for any other reason, special precautions are necessary, a Caution Order detailing the kilometres between which such precautions are necessary, the reasons for taking such precautions, and the speed at which a train shall travel, shall be handed over to the Loco Pilot.</p>' }
    ];
    ...
    console.log(`Updated ${rules.length} rules for Chapter 4`);
  } catch (error) {
